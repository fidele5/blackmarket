jQuery(document).ready(function(a) {
    ...
    a(".offcanvas-menu .offcanvas-submenu .back-btn").on("click", function(b) {
        ...
        Array.prototype.filter.call(a, function(a) { a.addEventListener("submit", function(b) {!1 === a.checkValidity() && (b.preventDefault(), b.stopPropagation()), a.classList.add("was-validated") }, !1) })
    }, !1);
    ...
    k.on("click", function(b) { a(b.target).parent().is(".expanded") ? d() : (d(), a(this).parent().addClass("expanded")) }), a('[data-toggle="tooltip"]').tooltip(), a('[data-toggle="popover"]').popover(), a(".price-range-slider").each(function() {
        var b = a(this),
            c = b.find(".ui-range-slider"),
            d = { dataStartMin: parseInt(c.parent().data("start-min"), 10), dataStartMax: parseInt(c.parent().data("start-max"), 10), dataMin: parseInt(c.parent().data("min"), 10), dataMax: parseInt(c.parent().data("max"), 10), dataStep: parseInt(c.parent().data("step"), 10), valueMin: b.find(".ui-range-value-min span"), valueMax: b.find(".ui-range-value-max span"), valueMinInput: b.find(".ui-range-value-min input"), valueMaxInput: b.find(".ui-range-value-max input") };
        noUiSlider.create(c[0], { start: [d.dataStartMin, d.dataStartMax], connect: !0, step: d.dataStep, range: { min: d.dataMin, max: d.dataMax } }), c[0].noUiSlider.on("update", function(a, b) {
            var c = a[b];
    ...
    if (l.length && l.card({ form: ".interactive-credit-card", container: ".card-wrapper" }), a(".gallery-wrapper").length) {
        ! function(b) {
    ...
    m.length && m.owlCarousel({ items: 1, loop: !1, dots: !1, URLhashListener: !0, startPosition: "URLHash", onTranslate: e });
    var n = a(".google-map");
